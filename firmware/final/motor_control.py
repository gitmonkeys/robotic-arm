...
# Constants
delay = 0.0001
microsteps_per_revolution = 800  # Microsteps per full revolution
...
def initialize_position():
    ...
    pi.write(ENA_PIN_3, 1)  # Turn ontepper motor 3
...
def open_gripper():
    move_servo_smoothly(135,0.01)

def close_gripper():
    move_servo_smoothly(0,0.01)
...
def go_trash(theta1, theta2, theta3):
    ...
    time.sleep(0.5)
 # Moving to recycle and then go home   

def go_recycle(theta1, theta2, theta3):
    print("Moving to recycle and returning home...")
    ...
    print("returning to home")
    # Return arms to initial position
    microsteps1_back = degrees_to_microsteps(-180,gear_ratio1)
    step_motor(PUL_PIN_1, DIR_PIN_1, microsteps1_back, delay)
