...
def homogeneous_transform():
    ...
    """
    T = np.array([[1, 0, 0, -30],  # X-axis translation
                  [0, -1, 0, 45],  # Y-axis translation (upside down)
...
def get_sorted_object_coordinates():
    ...
    for contour in contours:
        ...
        if cv2.contourArea(contour) < 500:  # Adjust this value based on your needs
            continue
        ...
        if(w>0.3 and h>0.3 and transformed_point[1]>5):
