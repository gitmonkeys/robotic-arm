...
def degrees_to_microsteps(degrees, motor_id):
    ...
    # Adjust degrees based on gear ratio for the specific motor
    adjusted_degrees = degrees * gear_ratios[motor_id]

    return int((adjusted_degrees / 360.0) * microsteps_per_revolution)
